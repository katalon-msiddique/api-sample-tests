...
WebUI.click(findTestObject('Object Repository/Web/Login/Page_CURA Healthcare Service/button_Login'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Web/Login/Page_CURA Healthcare Service/select_Tokyo CURA Healthcare Center        _5b4107'), 
    'Seoul CURA Healthcare Center', true)

WebUI.click(findTestObject('Object Repository/Web/Login/Page_CURA Healthcare Service/label_Apply for hospital readmission'))

WebUI.click(findTestObject('Object Repository/Web/Login/Page_CURA Healthcare Service/label_Medicaid'))

WebUI.click(findTestObject('Object Repository/Web/Login/Page_CURA Healthcare Service/input_Visit Date (Required)_visit_date'))
...
WebUI.takeScreenshotAsCheckpoint('appointment_confirmation_1')
